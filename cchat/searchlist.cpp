...
void SearchList::addTipItem()
{
    ...
    item_tmp->setSizeHint(QSize(280,10));
...
//1.监听 QListWidget item 点击事件。
//2.找到该 item 绑定的自定义 widget。
//3.判断该 widget 的类型（聊天条目、联系人条目、添加好友提示条目……）。
//4.如果是“添加好友提示条目”，就弹出 FindSuccessDlg 对话框，并显示搜索到的用户信息。
//5.其他情况则关闭已有的对话框。
